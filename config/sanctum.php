...
return [
    ...
    */
    ...
    | automated security scanning tools. See the documentation for more
    | information.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | When authenticating your multi-domain or single-page application, Sanctum
    | will need to inject some middleware into Laravel's global middleware
    | stack in order to properly handle CORS and CSRF options.
    |
    */
